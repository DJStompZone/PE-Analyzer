...
|      Info      |                           Package                           |             CI/CD              |
| :------------: | :---------------------------------------------------------: | :----------------------------: |
| [![PyPI - Python Version](https://img.shields.io/pypi/pyversions/pe-analyzer?logo=python&%230044aa&color=%230044aa&labelColor=%23dede00)](https://pypi.org/project/pe-analyzer/) | [![PyPI](https://img.shields.io/pypi/v/pe-analyzer?color=%2360d&label=latest%20%28pypi%29&logo=python&logoColor=%2360d&labelColor=%23101&style=flat)](https://pypi.org/project/pe-analyzer/) | [![Test](https://github.com/DJStompZone/PE-Analyzer/actions/workflows/codeql.yml/badge.svg)](https://github.com/DJStompZone/PE-Analyzer/actions/workflows/codeql.yml) |
